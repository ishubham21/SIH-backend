...
const seedTasks = () => __awaiter(void 0, void 0, void 0, function* () {
    yield prisma.cognitiveTask.createMany({
        data: [
            {
                ageGroup: "Preschool",
            ...
            },
            {
                ...
                questions: [
                    ...
                    {
                        questionText: "There are 60 minutes in 1 hour? How many minutes in 5 hours?",
                        answerOptions: [
                    ...
                    {
                        questionText: "A boy walks in north direction, then turns right. What direction is he facing?",
                        answerOptions: [
